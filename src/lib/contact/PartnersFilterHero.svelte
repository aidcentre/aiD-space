...
<section>
	<div class="max-w-[1920px] px-4 mx-auto my-30 md:my-40 lg:my-60">
		<div class="flex flex-col gap-6">
			...
			<div class="flex flex-wrap gap-4 mb-1.5">
				{#each categories as category (category)}
					...
					>
						<div class="aspect-square size-3.25 rounded {activeCategory === category ? 'bg-off-black' : 'border-2 border-grey'}"></div>
