...
<section class="grid grid-cols-1 gap-10 px-4 text-off-black lg:grid-cols-[1fr_5fr] lg:gap-0">
	...
	<div class="flex flex-col gap-10">
		<p
			class="w-full font-[Montagu_Slab] leading-[1.5rem] font-[1rem] font-normal lg:w-3/5 lg:pl-8 lg:text-[1.44rem] lg:leading-[2rem]"
		>
			...
			training is grounded in real-world industrial and societal needs.
		</p>
		<div class="flex flex-col gap-[1rem] lg:pl-8">
			<p class="text-[1rem] leading-[1.5rem] font-bold text-(--grey)">Key milestones</p>
			<div
				class="flex flex-col items-start justify-center gap-[1rem] sm:flex sm:w-9/10 sm:flex-row sm:justify-between"
			>
