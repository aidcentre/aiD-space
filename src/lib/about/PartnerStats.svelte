...
<div class="flex items-center gap-6">
	<div class="relative size-10 md:size-12 lg:size-16 min-w-fit">
		<img
			...
			class="w-full h-full"
		/>
		<div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-bold text-off-black text-lg lg:text-xl">{orgAmount}</div
		>
	</div>
	<div class="flex items-center">
		<Scramble text={orgType} speed="slow" class="text-lg lg:text-xl font-bold text-off-black" />
	</div>
</div>